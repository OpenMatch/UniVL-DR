...
def eval_loss(model, valid_reader):
    ...
    for step, batch in tqdm(enumerate(valid_reader)):
        with torch.no_grad():
            ...
            correct_predictions_count = (max_idxs == 0).sum() / query_embedding.size(0)
...
if __name__ == '__main__':
    ...
    args_dev.neg_num = 1
    valid_data = WebQADataset(args_dev, preprocess, valid_data, docs, captions=captions, shuffle=False)
